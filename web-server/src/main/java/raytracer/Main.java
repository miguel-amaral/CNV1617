...
//			"        -nocap    - cylinders and cones are infinite";
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		if(args.length < 8) {
			printUsage();
			throw new InterruptedException("Invalid Argument number");
		}
	...
	public void createImage(String[] args) throws Exception{
		if(args.length < 8) {
			throw new Exception("Invalid number of args : raytracer");
		}
